    ...
    <header>
        <div className="title">
          <a href="https://github.com/GuiEpi/plex-skipper" target="_blank">
            <img className='logo' src={plexSkipperLogo} alt="plex-skipper-logo"/>
            <h1>Plex Skipper</h1>
          </a>
        </div>
        <div className="switch">
          <input 
            ...
            checked={plexSkipper}
            onChange={(event: React.ChangeEvent<HTMLInputElement>) => handlePlexSkipperChange(event.target.checked)}
          />
      ...
      <div id="switch-section">
        <div className="switch">
          ...
          <input 
            ...
            onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleSkipIntroCreditChange(event.target.checked)}
        ...
        <div className="switch">
          ...
          <input 
            ...
            id="enablePlayNext"
            checked={playNext}
            onChange={(event: React.ChangeEvent<HTMLInputElement>) => handlePlayNextChange(event.target.checked)}
            disabled={!plexSkipper}
          />
